...
template<class T>
inline vector<T> MySQLcon::get_result(function<T(const vector<string>&)> fn,vector<string>* head){
	vector<T> res;
...
template<class T>
void MySQLcon::get_result_append(vector<T>& res,function<T(const vector<string>&)> fn,vector<string>* head){
